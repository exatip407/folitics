...
[
		...
		function($http, $q, $parse) {
			...
			function loadData(title, id) {
				...
				return $http.get(
				'/chart/getChart?ChartID=globalVerdictChartService&ChartSecondaryID='+title+'&id=1').then(function(response) {
			...
			return {
				...
				template : '<div id="globalOverAllVerdictdiv" style="min-width: 100%; height: 300px; margin: 0 auto"></div>',
