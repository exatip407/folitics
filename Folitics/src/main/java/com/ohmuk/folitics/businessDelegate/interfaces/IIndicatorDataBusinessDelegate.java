...
public interface IIndicatorDataBusinessDelegate {
    ...
    /**
     * Method is to get all {@link HeaderDataBean}
     * @return {@link HeaderDataBean}
     * @throws Exception
     */
    List<HeaderDataBean> readAllByThresholdGroup() throws Exception;

    /**
     * Method is to get all {@link TrackPromiseBean} by sub category
     * @return
     * @throws Exception
     */
    List<TrackPromiseBean> readAllBySubCategory() throws Exception;
