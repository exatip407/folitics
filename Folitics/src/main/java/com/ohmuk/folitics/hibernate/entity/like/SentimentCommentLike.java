...
/**
 * Entity for like on entity: {@link SentimentComment}
 * 
 * @author Harish
 *
 */
...
@Entity
@Table(name = "sentimentcommentlike")
public class SentimentCommentLike implements Serializable {
